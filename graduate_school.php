...
$sql = "SELECT * FROM files WHERE file_directory = 'Graduate School and Open Learning College' || file_directory = 'General' ORDER BY id ASC LIMIT $limit OFFSET $offset";
          ...
          ?>
            <tr class="results">
              ...
              <button class="btn btn-primary btn-sm" onclick="openLink('<?php echo $rows['file_viewLink'];?>')"><span class="glyphicon glyphicon-eye-open"></span> View</button>
                ...
                <?php
                        if ($rows['owner_email'] == $email || getUserLevel() == 0) {
                        ?>
