...
$sql = " SELECT * FROM files WHERE file_directory = 'College of Medicine' ORDER BY id ASC ";
            ...
            <table class="file-query">
                ...
                <tr class="results">
                    ...
                    <td>
                        ...
                        <button class="btn btn-danger btn-delete" type="button" onclick="deleteFile('<?php echo $rows['file_id']?>');delayDelete();"><span class="glyphicon glyphicon-trash"></span>Remove</button>
