...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_level == 2 || $user_level == 3) {
        if ($college == "") {
            ...
            $sql = "INSERT INTO access_request (first_name, last_name, email, birthdate, gender, user_level, college) VALUES ('$first_name', '$last_name', '$email', '$birthdate', '$gender', '$user_level', '$college')";
        }
    }
    else {
        $sql = "INSERT INTO access_request (first_name, last_name, email, birthdate, gender, user_level, college) VALUES ('$first_name', '$last_name', '$email', '$birthdate', '$gender', '$user_level', '$college')";
