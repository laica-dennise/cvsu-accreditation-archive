        ...
        <div class="profile-box">
          ...
          ?>
            <ul>
              ...
              <li style="cursor:default;font-size:15px;text-align:center;margin-right:40px;margin-bottom:20px;"><strong>User Level:</strong> College Accreditation Officer</li>
